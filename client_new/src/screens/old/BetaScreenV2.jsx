...
import BetaBezettingsgraadV2 from "../components/calendar/BetaBezettingsgraadV2";
import Stap6WeekPlanningV2 from '../components/calendar/control_components/Stap6WeekPlanningV2';
import { listWeekStructuren, step3BetaInitial, step5BetaInitial } from '../store/actions/betaActions';
import Stap6BetaV2 from '../components/calendar/Stap6BetaV2';



const BetaScreenV2 = (props) => {
    ...
    const progressText = [
        ...
        "STAP 2: Geef het aantal operatorshiften in voor de operatoren",
        "STAP 3: lets try this shit!"
    ]
                ...
                error ? (<div>{error}</div>) : (
                    <div className="container-fluid">
                                                        ...
                                                        <>
                                                            ...
                                                            <tr style={{
                                                                border: (Progress === 3 || Progress === 4) &&
                                                                    ...
                                                                    "3px solid red" : (Progress === 5 || Progress === 2) && (
                                                                        employees.find(x => x.id === individueleCalendar.employeeId).contracttype === "4-5" ||
                                                                        employees.find(x => x.id === individueleCalendar.employeeId).contracttype === "operator") ? "3px solid red" : "",

                                                                backgroundColor: (Progress === 3 || Progress === 4) && (
                                                                    employees.find(x => x.id === individueleCalendar.employeeId).contracttype === "4-5" ||
                                                                    employees.find(x => x.id === individueleCalendar.employeeId).contracttype === "operator") ?
                                                                    "darkgray" : (Progress === 5 || Progress === 2) && (
                                                                        employees.find(x => x.id === individueleCalendar.employeeId).contracttype !== "4-5" &&
                                                                ...
                                                                {individueleCalendar.employeeCalendar.map(shiftDay =>
                                                                    Progress===2&&Stap6Week?.isSame(moment(shiftDay.day, "DD-MM-YYYY"), 'day') && ["operator", "4-5"].includes(employees.find(empl => empl.id === individueleCalendar.employeeId).contracttype) ?
                                                                        <td colSpan={7} style={{ padding: "0px", margin: "0px", textAlign: "center" }}>
                                                                            <div style={{ padding: "0px", margin: "0px", border: "2px solid red" }}><Stap6WeekPlanningV2 id={individueleCalendar.employeeId} datum={moment(datum, "MM-YYYY").format("YYYY")} /></div>
                                                                        </td>
                        ...
                        <div className="row">
                            ...
                            {Progress !== 4 && Progress !== 1 && Progress !== 2 ?
                                (<>
                                    {/* SHIFT SELECTOR */}
                                            ...
                                            {
                                                {
                                                    ...
                                                    2:
                                                        <div className="card-body">
                                                            <Stap6BetaV2 setStap6Week={setStap6Week} />
                                                        </div>,
                                                }[Progress]
                                            }
