...
router.put("/:naam=", async (req,res)=>{
    const shifttypes = await Shifttypes_DB.updateShifttype(req.params.naam,req.body.naam,req.body.beginuur,req.body.einduur,req.body.vaste_uren,req.body.kleurcode, req.body.verplicht );
    if (shifttypes) {
        res.send(shifttypes);
    } else {
...
router.post("/", async(req,res)=>{
    const shifttypes = await Shifttypes_DB.addShifttype(req.body.naam,req.body.beginuur,req.body.einduur,req.body.vaste_uren,req.body.kleurcode, req.body.verplicht  );
    if (shifttypes) {
      res.send(shifttypes);
    } else {
